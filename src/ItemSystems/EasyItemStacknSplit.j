...
//=====================================================================================
    ...
    private function onInit takes nothing returns nothing
        ...
        loop
            call TriggerRegisterPlayerUnitEvent( trg, Player(x), EVENT_PLAYER_UNIT_PICKUP_ITEM, null )
            call TriggerRegisterPlayerUnitEvent( trg, Player(x), EVENT_PLAYER_UNIT_ISSUED_TARGET_ORDER, null )
        ...
        call TriggerAddCondition( trg, function ActionController )
