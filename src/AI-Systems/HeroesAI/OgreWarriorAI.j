scope OgreWarriorAI
    globals
        private constant integer HERO_ID = 'H01C'
    ...
    private struct AI extends array
        ...
        method onCreate takes nothing returns nothing
			...
			// Axe Throw
			call RegisterHeroAISkill(HERO_ID, 1, 'A09H')
			call RegisterHeroAISkill(HERO_ID, 5, 'A09H') 
			call RegisterHeroAISkill(HERO_ID, 9, 'A09H') 
			call RegisterHeroAISkill(HERO_ID, 13, 'A09H') 
			call RegisterHeroAISkill(HERO_ID, 16, 'A09H') 
			// Might Swing
			call RegisterHeroAISkill(HERO_ID, 2, 'A09I') 
			call RegisterHeroAISkill(HERO_ID, 7, 'A09I') 
			call RegisterHeroAISkill(HERO_ID, 10, 'A09I') 
			call RegisterHeroAISkill(HERO_ID, 14, 'A09I') 
			call RegisterHeroAISkill(HERO_ID, 17, 'A09I') 
			// Decapitate
			call RegisterHeroAISkill(HERO_ID, 3, 'A09K') 
			call RegisterHeroAISkill(HERO_ID, 8, 'A09K') 
			call RegisterHeroAISkill(HERO_ID, 11, 'A09K') 
			call RegisterHeroAISkill(HERO_ID, 15, 'A09K') 
			call RegisterHeroAISkill(HERO_ID, 19, 'A09K') 
			// Consumption
			call RegisterHeroAISkill(HERO_ID, 6, 'A09M')
			call RegisterHeroAISkill(HERO_ID, 12, 'A09M')
			call RegisterHeroAISkill(HERO_ID, 18, 'A09M')
			//Heroes Will
