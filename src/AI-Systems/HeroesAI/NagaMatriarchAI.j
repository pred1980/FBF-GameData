scope NagaMatriarchAI
    ...
    private struct AI extends array
        ...
        method onCreate takes nothing returns nothing
			...
			// Crushing Wave
			call RegisterHeroAISkill(HERO_ID, 1, 'A07R')
			...
			// Tidal Shield
			call RegisterHeroAISkill(HERO_ID, 3, 'A07O') 
			call RegisterHeroAISkill(HERO_ID, 8, 'A07O') 
			call RegisterHeroAISkill(HERO_ID, 11, 'A07O') 
			call RegisterHeroAISkill(HERO_ID, 15, 'A07O') 
			call RegisterHeroAISkill(HERO_ID, 19, 'A07O') 
			// Maelstrom
