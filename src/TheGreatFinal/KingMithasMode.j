scope KingMithasMode
    ...
    globals
        ...
        private constant integer HP = 25000
    ...
    globals
        ...
        private string SOUND_2 = "war3mapImported\\KingMarcoMithas01.mp3"
    ...
    struct KingMithasCore
		...
		static method onCreateKingMithas takes nothing returns nothing
			...
			set .hp = GetUnitStateSwap(UNIT_STATE_LIFE, .king)
	...
	struct KingCinematic
        ...
        static method step1 takes nothing returns nothing
		    call Sound.runSoundOnUnit(SOUND_1, KingMithasCore.fakeKing)
            ...
            call Sound.runSoundOnUnit(SOUND_2, KingMithasCore.fakeKing)
