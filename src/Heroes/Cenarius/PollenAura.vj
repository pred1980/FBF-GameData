scope PollenAura initializer init
    /*
     * Description: Cenarius summons deathly pollen around his body, slowing enemies attack speed and movement speed 
    ...
    private function MainSetup takes nothing returns nothing
        set LIFE_DEGENERATION[0] = 8.00
        set LIFE_DEGENERATION[1] = 16.00
        set LIFE_DEGENERATION[2] = 24.00
        set LIFE_DEGENERATION[3] = 32.00
        set LIFE_DEGENERATION[4] = 40.00
    
        set SPELL_RADIUS[0] = 700.00
        set SPELL_RADIUS[1] = 700.00
        set SPELL_RADIUS[2] = 700.00
        set SPELL_RADIUS[3] = 700.00
        set SPELL_RADIUS[4] = 700.00
